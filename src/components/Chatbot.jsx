    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-12 right-6 bg-indigo-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:bg-indigo-700 transition-all z-50"
        >
          <BsRobot size={28} />
        </button>
      )}
